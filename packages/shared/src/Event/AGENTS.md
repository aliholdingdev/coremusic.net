---
title: "CoreMusic - C:\www\coremusic.net\packages\shared\src\Event Agent Talimatlari"
type: agent-registry
folder: "C:\www\coremusic.net\packages\shared\src\Event"
category: layer3
date: 2026-09-06
status: active
version: 1.0.0
...
## 1. Amac
Entegrasyon olaylari

## 2. Icerik Envanteri
`MediaUploaded.php, PlaylistCreated.php, UserLoggedIn.php, UserLoggedOut.php`
