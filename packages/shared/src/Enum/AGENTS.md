---
title: "CoreMusic - C:\www\coremusic.net\packages\shared\src\Enum Agent Talimatlari"
type: agent-registry
folder: "C:\www\coremusic.net\packages\shared\src\Enum"
category: layer3
date: 2026-09-06
status: active
version: 1.0.0
...
## 2. Icerik Envanteri
`DeviceType.php, MediaType.php, PermissionAction.php, UserRole.php`
