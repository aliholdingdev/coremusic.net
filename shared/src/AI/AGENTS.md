---
title: "CoreMusic - C:\www\coremusic.net\shared\src\AI Agent Talimatlari"
type: agent-registry
...
## 2. Icerik Envanteri
`AIEngine.php, AIOrchestrator.php, AIWorkflow.php, KnowledgeBase.php, MemorySystem.php, PromptEngine.php, ToolCalling.php`
