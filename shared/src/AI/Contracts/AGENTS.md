---
title: "CoreMusic - C:\www\coremusic.net\shared\src\AI\Contracts Agent Talimatlari"
type: agent-registry
...
## 2. Icerik Envanteri
`AIEngineInterface.php, AIOrchestratorInterface.php, KnowledgeBaseInterface.php, MemorySystemInterface.php, PromptEngineInterface.php, ToolCallingInterface.php`
