---
title: "CoreMusic - C:\www\coremusic.net\shared\src\Exception Agent Talimatlari"
type: agent-registry
...
## 2. Icerik Envanteri
`AuthenticationException.php, AuthorizationException.php, BaseCoreMusicException.php, ConflictException.php, ErrorResponse.php, RateLimitException.php, ServerException.php, ValidationException.php`
