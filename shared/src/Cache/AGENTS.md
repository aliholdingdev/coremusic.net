---
title: "CoreMusic - C:\www\coremusic.net\shared\src\Cache Agent Talimatlari"
type: agent-registry
folder: "C:\www\coremusic.net\shared\src\Cache"
category: layer3
date: 2026-09-06
status: active
version: 1.0.0
...
## 1. Amac
Onbellek adapterlari (ADR-007)

## 2. Icerik Envanteri
`ApcuAdapter.php, CacheInterface.php, CacheManager.php, MemoryAdapter.php, PageCacheAdapter.php, PageCacheInterface.php`
