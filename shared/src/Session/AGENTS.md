---
title: "CoreMusic - C:\www\coremusic.net\shared\src\Session Agent Talimatlari"
type: agent-registry
folder: "C:\www\coremusic.net\shared\src\Session"
category: layer3
date: 2026-09-06
status: active
version: 1.0.0
...
## 1. Amac
Oturum yonetimi (ADR-011)

## 2. Icerik Envanteri
`SessionBootstrapper.php, SessionConfig.php, SessionInitializer.php, SessionLifecycle.php`
