---
title: "CoreMusic - C:\www\coremusic.net\assets.coremusic.net\js\core Agent Talimatlari"
type: agent-registry
folder: "C:\www\coremusic.net\assets.coremusic.net\js\core"
category: layer3
date: 2026-09-06
status: active
version: 1.0.0
...
## 1. Amac
Uygulama cekirdek JS (App, EventBus)

## 2. Icerik Envanteri
`CoreMusicApp.js, EventBus.js, footer.init.js, helper.js`
