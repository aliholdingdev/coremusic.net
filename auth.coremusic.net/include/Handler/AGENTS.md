---
title: "CoreMusic - C:\www\coremusic.net\auth.coremusic.net\include\Handler Agent Talimatlari"
type: agent-registry
folder: "C:\www\coremusic.net\auth.coremusic.net\include\Handler"
category: layer3
date: 2026-09-06
status: active
version: 1.0.0
...
## 2. Icerik Envanteri
`AuthKeyRedirectHandler.php, AuthPostHandler.php, AutoRedirectHandler.php`
