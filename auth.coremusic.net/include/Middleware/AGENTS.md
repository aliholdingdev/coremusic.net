---
title: "CoreMusic - C:\www\coremusic.net\auth.coremusic.net\include\Middleware Agent Talimatlari"
type: agent-registry
...
## 2. Icerik Envanteri
`MiddlewareInterface.php, MiddlewarePipeline.php, OriginCheckMiddleware.php, RateLimitMiddleware.php, SecurityHeadersMiddleware.php, SessionMiddleware.php`
