---
title: "CoreMusic - C:\www\coremusic.net\auth.coremusic.net\tests\Unit\Domain\ValueObject Agent Talimatlari"
type: agent-registry
...
## 2. Icerik Envanteri
`EmailTest.php, GenderTest.php, PasswordTest.php`
