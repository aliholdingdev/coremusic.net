---
title: "CoreMusic - C:\www\coremusic.net\.opencode\skills\database-normalize-maker\templates Agent Talimatlari"
type: agent-registry
...
## 2. Icerik Envanteri
`migration-template.sql, schema-template.sql, seed-template.sql`
